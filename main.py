...
1. ABSOLUTE ZERO: Temperature cannot be below -273.15C
    ...
    for e in entities:
        ...
        if e.has_injection:
            node_summary_parts.append(
                f"  WARNING: {e.node_id} sys_log contained a PROMPT INJECTION ATTACK."
            )
...
def main():
    ...
    for nid in all_ids:
        status = "[red]WARNING COMPROMISED[/red]" if nid in compromised else "[green]OK VERIFIED[/green]"
